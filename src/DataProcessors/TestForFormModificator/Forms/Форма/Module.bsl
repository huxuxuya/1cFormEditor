...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭлементГруппаБулево = ккПодготовкаФорм.ДобавитьГруппуНаФорму(КонтекстФормы, "ГруппаБулево", ПараметрыОтображения); 
	...
	РеквизитРеквизитДобавитьПолеНаФорму = ккПодготовкаФорм.ДобавитьПолеНаФорму(КонтекстГруппыЛево, "РеквизитДобавитьПолеНаФорму", ПараметрыОтображения);
	...
	ЭлементТаблицаПроверряемыеМетодыУспех = ккПодготовкаФорм.ДобавитьПолеТабличнойЧастиНаформу(КонтекстФормы, "Объект.ПроверяемыеПроцедурыИФункции", "Успех", ЭлементТаблицаПроверряемыеМетоды);
	...
	Кнопка3 = ккПодготовкаФорм.ДобавитьКомандуИКнопкуКоманднойПанели(КонтекстФормы, "КомандаКнопки3", "КомандаКнопки3", ЭлементТаблицаПроверряемыеМетоды.КоманднаяПанель);
	...
	Кнопка3 = ккПодготовкаФорм.ДобавитьКомандуИКнопкуНаФорму(КонтекстФормы, "КомандаКнопки4", "КомандаКнопки4", ПараметрыОтображения, ОсновнаяГруппаЛево);
