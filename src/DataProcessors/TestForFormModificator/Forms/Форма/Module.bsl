...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ГруппаСтроковыхРеквизитовПраво = Элементы.ГруппаСтроковыхРеквизитовПраво;
	...
	Кнопка3 = РедакторФорм.ДобавитьКомандуИКнопкуКоманднойПанели(КонтекстФормы, "КомандаКнопки3", "Обновить");
