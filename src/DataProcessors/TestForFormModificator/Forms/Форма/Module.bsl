...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КонтекстГруппыЛево = РедакторФорм.СоздатьКонтекстЭлемента(ЭтотОбъект, ОсновнаяГруппаЛево, ЭлементРеквизитБулево);
	...
	РеквизитРеквизитДобавитьПолеНаФорму = РедакторФорм.ДобавитьПолеНаФорму(КонтекстГруппыЛево, "РеквизитДобавитьПолеНаФорму");
	...
	//Правая колонка
	КонтекстГруппыПраво = РедакторФорм.СоздатьКонтекстЭлемента(ЭтотОбъект, ОсновнаяГруппаПраво);
	...
	РедакторФорм.ДобавитьПолеНаФормуРеквизитФормы(КонтекстГруппыБулево, "РеквизитДобавитьПолеНаФормуРеквизитФормы");
	...
	ЭлементФлажок = РедакторФорм.ДобавитьРеквизитОбъектаНаФорму(КонтекстГруппыБулево, "ВсегоПроцедурИФункций");
	ДобавитьКСчетчикуПоМетоду("ДобавитьРеквизитОбъектаНаФорму", 1);	
	ДобавитьКСчетчикуПоМетоду("ДобавитьГруппуНаФорму", , 1);

	ЭлементФлажок = РедакторФорм.ДобавитьРеквизитОбъектаНаФорму(КонтекстГруппыБулево, "ВсегоУспешных");
	ДобавитьКСчетчикуПоМетоду("ДобавитьРеквизитОбъектаНаФорму", 1);	
	ДобавитьКСчетчикуПоМетоду("ДобавитьГруппуНаФорму", , 1);
	...
	Кнопка = РедакторФорм.ДобавитьКнопкуНаФорму(КонтекстФормы, "КнопкаКоманды1", ВидКнопкиФормы.ОбычнаяКнопка, "Подключаемый_КомандаКнопки1");
	ДобавитьКСчетчикуПоМетоду("ДобавитьКнопкуНаФорму", 1);
	ДобавитьКСчетчикуПоМетоду("ДобавитьГруппуКнопок", , 1);
	
	//
	Кнопка2 = РедакторФорм.ДобавитьКомандуИГиперссылкуНаФорму(КонтекстФормы, "КомандаКнопки2", "Подключаемый_КомандаКнопки2", "КомандаКнопки2", ОсновнаяГруппаЛево);
	...
	Кнопка3 = РедакторФорм.ДобавитьКомандуИКнопкуНаФорму(КонтекстФормы, "КомандаКнопки4", "КомандаКнопки4");
