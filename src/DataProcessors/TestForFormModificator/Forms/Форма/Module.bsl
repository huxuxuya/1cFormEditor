...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КонтекстКоманда = РедакторФорм.СоздатьКонтекстЭлемента(ЭтотОбъект, ГруппаПерваяСтраница);	
	КонтекстКоманда.Свойства = Новый Структура("Заголовок", "Подробнее");
	РедакторФорм.ДобавитьКомандуНаФорму(КонтекстКоманда, "Подключаемый_КомандаКнопки1", "Подключаемый_КомандаКнопки1", "КомандаКнопки1");
	...
	КонтекстКоманда2 = РедакторФорм.СоздатьКонтекстЭлемента(ЭтотОбъект, ГруппаВерхПраво);
	Кнопка2 = РедакторФорм.ДобавитьКомандуИГиперссылкуНаФорму(КонтекстКоманда2, "КомандаКнопки2", "Подключаемый_КомандаКнопки2", "Очистить все");
	...
	РеквизитРеквизитДобавитьПолеНаФорму = РедакторФорм.ДобавитьПолеНаФорму(КонтекстФормыПоле, "РеквизитДобавитьПолеНаФорму");
	ДобавитьКСчетчикуПоМетоду("ДобавитьПолеНаФорму", 1);	
	ДобавитьКСчетчикуПоМетоду("ДобавитьПолеНаФормуРеквизитОбъекта", , 1);	
	...
	КонтекстГруппыКнопок = РедакторФорм.СоздатьКонтекстЭлемента(ЭтотОбъект, ЭлементГруппаБулево);
	КонтекстГруппыКнопок.Свойства = Новый Структура("Заголовок", "Информация");
