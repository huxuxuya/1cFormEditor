...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КонтекстФормы.ПараметрыОтображения = Новый Структура("Вид, Группировка, ОтображатьЗаголовок", ВидГруппыФормы.ОбычнаяГруппа, ГруппировкаПодчиненныхЭлементовФормы.ГоризонтальнаяЕслиВозможно, Ложь);
	...
	КонтекстФормы.ПараметрыОтображения = Новый Структура;
	КонтекстФормы.ПараметрыОтображения.Вставить("ПутьКДанным", "РеквизитДобавитьПолеНаФорму");
	...
	КонтекстФормы.Родитель = ОсновнаяГруппаЛево;	
	КонтекстФормы.ПараметрыОтображения = Новый Структура("Заголовок", "Подвести итог");
