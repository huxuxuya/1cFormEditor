...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ГруппаИтоговойТаблицы = РедакторФорм.ДобавитьГруппуОбычную(КонтекстФормы, "ГруппаИтоговойТаблицы");
	ГруппаРеквизитовИтогов = РедакторФорм.ДобавитьГруппуОбычную(КонтекстФормы, "ГруппаРеквизитовИтогов");
	
	// Первая страница
	КонтекстФормы = РедакторФорм.СоздатьКонтекстЭлемента(ЭтотОбъект, ГруппаПерваяСтраница);
	ГруппаМногострочноеПоле = РедакторФорм.ДобавитьГруппуОбычную(КонтекстФормы, "ГруппаМногострочноеПоле");
	...
	РедакторФорм.ДобавитьКомандуИКнопкуНаФорму(КонтекстПраво, "КомандаКнопки4", "КомандаКнопки4");
