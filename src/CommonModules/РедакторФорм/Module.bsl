...
// Функция добавляет поле на форму для имеющегося реквизита формы
//
// Параметры:
//  КонтекстЭлемента - Структура - описание окружения создаваемого элемента и его свойств.
// 		* Форма - УправляемаяФорма - форма для которой выполняется действие.
...
//	ЭлементФормы - добавленный на форму, основная группа, которые содержит группы, которые являются колонками.
//
Функция ДобавитьГруппуОбычную(КонтекстЭлемента, ИмяЭлемента) Экспорт
...
// Функция добавляет таблицу на форму по описанию колонок
//
// Параметры:
//  КонтекстЭлемента - Структура - описание окружения создаваемого элемента и его свойств.
// 		* Форма - УправляемаяФорма - форма для которой выполняется действие.
...
// Функция добавляет имеющийся реквизит таблицы на форму в таблицу формы
//
// Параметры:
//  КонтекстЭлемента - Структура - описание окружения создаваемого элемента и его свойств.
// 		* Форма - УправляемаяФорма - форма для которой выполняется действие.
...
// Функция группу кнопок на форму, автоматически гененрируя имена элементов по шаблону ГруппаКнопокФормы+Номергруппы.
//
// Параметры:
//  КонтекстЭлемента - Структура - описание окружения создаваемого элемента и его свойств.
// 		* Форма - УправляемаяФорма - форма для которой выполняется действие.
