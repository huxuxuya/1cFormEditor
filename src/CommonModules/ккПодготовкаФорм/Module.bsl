...
//	ккПодготовкаФорм.ДобавитьПолеНаФорму(ЭтаФорма, "ккРасшифровкаПлатежаОснованиеПлатежа", Свойства, Элементы.РасшифровкаПлатежа);
//
// Добавление элмента на форму
//	Свойства.Вставить("ПутьКДанным", "ВидДоговора");
//	ккПодготовкаФорм.ДобавитьПолеНаФорму(ЭтаФорма, "ВидДоговора", Свойства, Элементы.БыстрыеОтборы, Истина);
//
