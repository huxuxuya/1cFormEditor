...
//
Функция ДобавитьГруппуСКолонкамиЛевоИПраво(КонтекстЭлемента, ИмяОсновнойГруппы, ПараметрыОтображения) Экспорт
...
//
Функция ДобавитьКомандуНаФорму(КонтекстЭлемента, КонтекстЭлемента, ИмяДействия, Заголовок, Подсказка = "") Экспорт
