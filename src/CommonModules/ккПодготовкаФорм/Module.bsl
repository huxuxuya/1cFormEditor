...
// 	ПараметрыОтображенияЭлемента - Структура - Структура по которой заполняются свойства.
...
Функция СоздатьКонтекстЭлемента(Форма, 
								...
								ПараметрыОтображенияЭлемента = Неопределено) Экспорт
	...
	Если ПараметрыОтображенияЭлемента = Неопределено Тогда
		СтруктураКонтекст.Вставить("ПараметрыОтображения", Новый Структура());		
	Иначе
		СтруктураКонтекст.Вставить("ПараметрыОтображения", ПараметрыОтображенияЭлемента);
	КонецЕсли;
...
Функция ДобавитьПолеНаФорму(КонтекстЭлемента, ИмяПоля) Экспорт
	...
	ПараметрыОтображения = КонтекстЭлемента.ПараметрыОтображения;
...
Функция ДобавитьГруппуСКолонкамиЛевоИПраво(КонтекстЭлемента, ИмяОсновнойГруппы) Экспорт
	...
	КонтекстНовогоЭлемента = СоздатьКонтекстЭлемента(Форма, ГруппаФормы, , ПараметрыОтображенияВложенных);
...
Функция ДобавитьПолеТабличнойЧастиНаформу(КонтекстЭлемента, ПутьТабличнойЧасти, ИмяКолонкиТабличнойЧасти) Экспорт
	...
	ПараметрыОтображенияЭлемента = Новый Структура;
	ПараметрыОтображенияЭлемента.Вставить("ПутьКДанным", ПутьКДанным);
	Если ТипЗнч(ПараметрыОтображения) = Тип("Структура") Тогда
		Для Каждого Эл Из ПараметрыОтображения Цикл
			ПараметрыОтображенияЭлемента.Вставить(Эл.Ключ, Эл.Значение);	
		КонецЦикла;
	КонецЕсли;	
		
	КонтекстНовогоЭлемента = СоздатьКонтекстЭлемента(Форма, Родитель, , ПараметрыОтображенияЭлемента);
