...
//
Функция ДобавитьДинамическийСписокФормы(КонтекстЭлемента, ИмяСписка, ОсновнаяТаблица) Экспорт
	
	Форма = КонтекстЭлемента.Форма;
	Свойства = КонтекстЭлемента.Свойства;
	
	Если ЕстьСвойствоКоллекции(Форма, ИмяСписка) Тогда
...
Функция ЕстьСвойствоКоллекции(Коллекция, ИмяСвойства)
	...
	ЗаполнитьЗначенияСвойств(СтруктураАнализируемая, Коллекция, ИмяСвойства);
